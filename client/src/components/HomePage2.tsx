    ...
    <div className="min-h-screen bg-black text-white overflow-hidden">
        ...
        {Array.from({ length: 5 }).map((_, i) => (
          <motion.div
            ...
            style={{
              ...
              background: "radial-gradient(circle, rgba(0,77,0,0.3) 0%, rgba(0,0,0,0) 70%)",
            }}
          >
        ...
        <div className="absolute bottom-0 left-0 right-0 h-40 flex items-end justify-around opacity-20">
          {Array.from({ length: 20 }).map((_, i) => (
            <motion.div
              ...
              initial={{ height: 10 }}
              animate={{
                height: [Math.random() * 30 + 10, Math.random() * 100 + 20, Math.random() * 30 + 10],
              }}
              transition={{
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-lg">
                Own, trade, and experience music in a whole new way. Direct artist support with transparent royalties on
                the blockchain.
              </p>

              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <button className="bg-[#90EE90] hover:bg-[#7CCD7C] text-black text-lg px-8 py-6">Explore Music</button>
                <button
                  className="border-[#90EE90] text-[#90EE90] hover:bg-[#90EE90]/10 text-lg px-8 py-6"
                >
                  For Artists
                </button>
              </div>
              ...
              >
                ...
                <div className="absolute inset-0 rounded-full overflow-hidden">
                  <motion.div
                    ...
                    animate={{ opacity: [0.6, 0.8, 0.6], x: ["100%", "-100%", "100%"] }}
                    transition={{
                      duration: 8,
                      repeat: Number.POSITIVE_INFINITY,
                      ease: "linear",
      ...
      <section className="relative z-10 py-20 bg-[#001a00]/80">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-4xl font-bold mb-4" style={{ fontFamily: "'Audiowide', cursive" }}>
              Revolutionary <span className="text-[#90EE90]">Features</span>
            </h2>
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Experience music ownership like never before with our blockchain technology
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: "Own your music as NFTs with verifiable proof of ownership on the blockchain",
              },
              {
                icon: <Zap className="h-10 w-10 text-[#90EE90]" />,
                title: "Instant Royalties",
                description: "Artists receive royalties instantly when their music is purchased or traded",
              },
              {
                icon: <Share2 className="h-10 w-10 text-[#90EE90]" />,
                title: "Community Governance",
                description: "Participate in platform decisions with our governance token system",
              },
            ].map((feature, index) => (
              <motion.div
                key={index}
      ...
      <section className="relative z-10 py-20">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-4xl font-bold mb-4" style={{ fontFamily: "'Audiowide', cursive" }}>
              Experience <span className="text-[#90EE90]">Music</span> Differently
            </h2>
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            ...
            <div className="absolute inset-0 flex items-end justify-around">
              {Array.from({ length: 40 }).map((_, i) => (
                <motion.div
                  ...
                  style={{
                    background: `linear-gradient(to top, #90EE90 ${Math.random() * 20 + 10}%, #004d00)`,
                    filter: "blur(1px)",
                  }}
                />
              ))}
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              ...
              >
                ...
                <p className="text-gray-300 mb-4">
                  Every beat is a token, every melody an asset. Own the music you love.
                </p>
                <button className="bg-[#90EE90] hover:bg-[#7CCD7C] text-black">Explore the Sound</button>
              </motion.div>
            </div>
          </div>
        </div>
      ...
      <section className="relative z-10 py-20">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">Join the music revolution in three simple steps</p>
          </motion.div>
            ...
            {[
              {
                ...
                description: "Link your crypto wallet to access the BlockBeats platform",
              },
              {
                number: "02",
                title: "Discover Music",
                description: "Browse exclusive tracks and albums from your favorite artists",
              },
              {
                number: "03",
                title: "Collect & Enjoy",
                description: "Purchase music NFTs and enjoy exclusive perks and content",
              },
            ].map((step, index) => (
              <motion.div
                key={index}
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div>
              ...
              <p className="text-xl text-gray-300 max-w-2xl">Discover trending creators on the platform</p>
            </div>
            <button  className="text-[#90EE90] flex items-center gap-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { name: "Crypto Beats", genre: "Electronic", followers: "245K" },
              { name: "BlockChain Harmony", genre: "Hip Hop", followers: "189K" },
              { name: "Digital Assets", genre: "Pop", followers: "320K" },
              { name: "NFT Soundscape", genre: "Ambient", followers: "156K" },
            ].map((artist, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, scale: 0.9 }}
              ...
              >
                <div className="bg-gradient-to-br from-[#002200] to-black rounded-xl overflow-hidden">
                  <div className="aspect-square relative overflow-hidden">
                    ...
                    <img
                      src={`/placeholder.svg?height=400&width=400&text=${artist.name}`}
                      alt={artist.name}
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex justify-between items-center mt-2">
                      ...
                      <span className="text-[#90EE90] flex items-center gap-1">
                        <Music className="h-4 w-4" /> {artist.followers}
                      </span>
                    </div>
                  </div>
                </div>
          ...
          >
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
              <div className="max-w-2xl">
                <h2 className="text-3xl md:text-4xl font-bold mb-4" style={{ fontFamily: "'Audiowide', cursive" }}>
                  Ready to Join the <span className="text-[#90EE90]">Music Revolution</span>?
                </h2>
                <p className="text-xl text-gray-200">
                  Get early access to exclusive drops, artist collaborations, and special perks.
                </p>
              </div>

              <div className="w-full md:w-auto">
                <button className="w-full md:w-auto bg-[#90EE90] hover:bg-[#7CCD7C] text-black text-lg px-8 py-6">
                  Get Started Now
                </button>
              </div>
            </div>
      ...
      <footer className="relative z-10 py-12 border-t border-[#004d00]">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-xl font-bold" style={{ fontFamily: "'Audiowide', cursive" }}>
                  BLOCKBEATS
                </h2>
              </div>
              <p className="text-gray-400">
                Revolutionizing the music industry through blockchain technology and direct artist support.
              </p>
            </div>
              ...
              <div key={index} className="space-y-4">
                ...
                <ul className="space-y-2">
                  {column.links.map((link, i) => (
                    <li key={i}>
                      <Link href="#" className="text-gray-400 hover:text-[#90EE90] transition-colors">
                        {link}
                      </Link>
                    </li>
                  ))}
          ...
          <div className="mt-12 pt-8 border-t border-[#004d00] flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">© {new Date().getFullYear()} BlockBeats. All rights reserved.</p>

...
const Page = () => {
  ...
  if(!isRegistered){
    return (
      <div className='flex items-center justify-center min-h-screen bg-gray-900 text-white'>
        <h1 className='text-2xl font-bold'>Please register to view your profile</h1>
        <Link href={'/user'} className='ml-4 text-purple-400 underline'>
            Register
        </Link>
      </div>
    )
            ...
            <div className='flex items-center'>
              {artistLoading ? (
                ...
                <div className='flex items-center'>
                  ...
                  <div
                    onClick={() => setMode(mode === 'user' ? 'artist' : 'user')}
          ...
          <>
            <div className='bg-gradient-to-r from-purple-900/40 to-gray-800 rounded-xl p-6 shadow-lg mb-8 border border-gray-700'>
              <div className='flex items-center'>
                ...
                <Link
                  href='/songs/upload'
                  className='bg-purple-600 hover:bg-purple-700 text-white py-2 px-6 rounded-full font-medium flex items-center transition-colors ml-4'>
                  <svg
                    className='w-5 h-5 mr-1'
                    fill='none'
                    stroke='currentColor'
